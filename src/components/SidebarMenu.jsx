...
const SidebarMenu = ({ activeItem = 'dashboard' }) => {
  ...
  const menuItems = [
    ...
    { id: 'discovery', label: 'Discovery', icon: Compass, route: '/dashboard/discovery' },
    { id: 'communication', label: 'Communication', icon: MessageCircle, route: '/dashboard/communication' },
  ]
