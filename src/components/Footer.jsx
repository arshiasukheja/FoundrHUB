    ...
    <div className="max-w-7xl mx-auto px-6 lg:px-10 py-12">
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-16 mb-12">
        <div className="sm:col-span-2 lg:col-span-1">
          <Link to="/" className="font-serif text-[20px] text-white tracking-tight">
        ...
        {[
          ...
          <div key={col.t}>
            ...
            <ul className="space-y-2.5">
              {col.l.map(item => (
                <li key={item.label}>
                  <Link to={item.to} className="text-[13px] text-neutral-400 hover:text-white transition-colors duration-300">
                    {item.label}
                  </Link>
                </li>
              ))}
      ...
      <div className="pt-8 border-t border-neutral-800/50">
        <p className="text-[12px] text-neutral-600">© 2026 FoundrHUB. All rights reserved.</p>
      </div>
    </div>
  </footer>
)
